...
<div class="navigation-bar">
    <a href="index.html" id="logo"><img src="images/Logo.svg" alt="zagross tour"></a>
    <nav>
        <ul>
...
<div class="last-tour-border">
    ...
    <div class="last-tour">
        <?php
        foreach ($tour->select_special() as $tr){
            ...
            <a href='index.html'>مشاهده | سفارش</a>
        </div>
";
        }
        ?>
